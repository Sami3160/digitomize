...
export function SignupFormDemo() {
  ...
  const navigate=useNavigate()
    ...
    return (
        <div className="w-[90%] mx-auto flex relative  rounded-none md:rounded-2xl p-4 md:p-8 shadow-input bg-white dark:bg-black"
        >
            {
                isSuccess && (
                    <div className="absolute left-1/2  transform -translate-x-1/2 ">
                        <SuccessMessages head={"Success"} description={"Successfully user regisitered"} />
                    </div>
                )
            }
            {
